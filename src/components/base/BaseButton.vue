...
const buttonClasses = computed(() => {
  ...
  const variantClasses = {
    ...
    tertiary: 'bg-transparent text-white-100 hover:bg-white-100/10 active:bg-white-100/15 disabled:text-white-80 disabled:bg-transparent disabled:hover:bg-transparent'
  }
