<template>
    <div class="relative w-full h-[72px] flex items-center justify-center">
        ...
        <!-- Пины (точки) -->
        <div v-if="pinCount > 0" class="absolute w-full flex justify-between items-center top-1/2 -translate-y-1/2">
            <svg v-for="index in pinCount" width="9" height="9" viewBox="0 0 9 9" fill="none"
                xmlns="http://www.w3.org/2000/svg" :key="index" :style="{
